...
Source0  : https://files.pythonhosted.org/packages/a2/46/42526e9e0f6d67966bd15364fc3713ac5a3501204868e472583f12c5271d/expecttest-0.1.6.tar.gz
...
%prep
%setup -q -n expecttest-0.1.6
cd %{_builddir}/expecttest-0.1.6
pushd ..
cp -a expecttest-0.1.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690900020
